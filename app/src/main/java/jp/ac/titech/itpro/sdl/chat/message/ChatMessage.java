...
public class ChatMessage implements Parcelable {
    ...
    public final int sound_signal;

    public ChatMessage(int seq, long time, String content, String sender, int sound_signal) {
        this.seq = seq;
        this.time = time;
